        ...
        <button className='relative -left-5 -bottom-5 sm:-left-0 sm:-bottom-0'>
            ...
            {isOpen ? (
                <motion.div
                    ...
                    className='flex flex-col h-[80%] w-[80%] sm:h-[90%]  justify-between items-center text-light font-montserrat fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/90 dark:bg-light/75 dark:text-dark rounded-lg backdrop-blur-md py-40'
                >
                    <div className='relative  flex flex-col font-mont h-full w-4/5  sm:w-5/6 -top-28 bottom-auto'>
                        {/* Contenu de la partie messenger */}
                        <h1 className='text-4xl sm:text-lg font-bold dark:text-dark mb-5'>
                            Y a-t-il d'autres mystères que vous souhaitez éclaircir ?
                        </h1>
                        <p className='text-lg sm:text-base font-semibold  mb-4'>
                            Voici d'autres exemples de question  :
                        </p>
                        <ul className='font-light mb-4 sm:mb-2'>
                            <li className='text-lg sm:text-sm mb-2'>I'd like to change the text color to blue and the background to green, please.</li>
                            <li className='text-lg sm:text-sm mb-2'>Let's update the description to highlight your strengths and skills.</li>
                            ...
                            <p className='text-xl sm:text-base font-bold text-red-600 mb-4 mt-4'>
                                ⚠️ Si vous rencontrez un problème, suivez ces étapes :
                            </p>
                            <ul className='font-light sm:text-sm sm:mb-2 mb-4'>
                                <li >
